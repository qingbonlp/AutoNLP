...
#     file_path = '../offline_data/offline_data/O1/O1.data/'
#     metadata = file_path+'meta.json'
#
#     with open(metadata,'r')  as  f:
#         metadata = json.load(f)
#
#     train_x = []
#     with open(file_path+'train.data','r')  as f:
#         train_x = f.read().split('\n')
#         train_x = train_x[:-1]
#     train_y = numpy.loadtxt(file_path+"train.solution")
#     m = Model(metadata)
